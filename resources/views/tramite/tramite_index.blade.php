                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <form action="{{ route('tramite_index') }}" method="GET" class="d-flex align-items-center">
                                ...
                                <div class="form-floating me-2">
                                    <input type="text" class="form-control" name="buscar"
                                        ...
                                        placeholder="ejemplo: Roberto Vinicio" aria-describedby="buscarHelp">
                        ...
                        <div class="d-flex justify-content-between">
                            <div>
                                <small>Mostrando {{ $tramites->firstItem() }} a {{ $tramites->lastItem() }} de
                                    {{ $tramites->total() }} trámites</small>
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <a href="{{ route('tramite_exportar_pdf') }}" class="me-2">
                                <button id="download-pdf" class="btn btn-outline-danger btn-lg">
                                    <i class="bi bi-file-earmark-pdf"></i> Descargar PDF
                                </button>
                            </a>
                            <a href="{{ route('tramite_exportar_excel') }}">
