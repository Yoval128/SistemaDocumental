...
Route::name('area_exportar_pdf')->get('/area_exportar_pdf', [AreaController::class, 'area_exportar_pdf']);
Route::name('area_exportar_excel')->get('/area_exportar_excel', [AreaController::class, 'area_exportar_excel']);
...
Route::name('rol_exportar_pdf')->get('/rol_exportar_pdf', [RolController::class, 'rol_exportar_pdf']);
Route::name('rol_exportar_excel')->get('/rol_exportar_excel', [RolController::class, 'rol_exportar_excel']);
...
Route::name('tramite_exportar_pdf')->get('/tramite_exportar_pdf', [TramiteController::class, 'tramite_exportar_pdf']);
Route::name('tramite_exportar_excel')->get('/tramite_exportar_excel', [TramiteController::class, 'tramite_exportar_excel']);
...
Route::name('concentracion_exportar_pdf')->get('/concentracion_exportar_pdf', [ConcentracionController::class, 'concentracion_exportar_pdf']);
Route::name('concentracion_exportar_excel')->get('/concentracion_exportar_excel', [ConcentracionController::class, 'concentracion_exportar_excel']);
...
Route::name('historico_exportar_pdf')->get('/historico_exportar_pdf', [HistoricoController::class, 'historico_exportar_pdf']);
Route::name('historico_exportar_excel')->get('/historico_exportar_excel', [HistoricoController::class, 'historico_exportar_excel']);
